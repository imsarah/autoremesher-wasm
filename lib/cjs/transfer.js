...
exports.transferAttribute = transferAttribute;
exports.transferUVs = transferUVs;
const LEAF_SIZE = 4;
class TriangleBvh {
 ...
 */
function transferAttribute(source, values, itemSize, targetPositions) {
...
function transferUVs(source, targetPositions) {
