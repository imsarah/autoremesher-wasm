...
exports.threadsSupported = threadsSupported;
exports.loadAutoRemesherModule = loadAutoRemesherModule;
exports.runNativeRemesh = runNativeRemesh;
const glue_loader_js_1 = require("./glue-loader.js");
 ...
 */
function loadAutoRemesherModule(options = {}) {
...
async function instantiate(options, threaded) {
    const factory = await (0, glue_loader_js_1.loadGlueFactory)(threaded);
 ...
 */
function runNativeRemesh(module, vertices, indices, params) {
    ...
    if (!verticesPtr || !indicesPtr) {
        ...
        throw new types_js_1.AutoRemesherError("Failed to allocate WASM heap memory for input mesh", -100);
    }
    let code;
    try {
    ...
    if (code !== 0) {
        ...
        throw new types_js_1.AutoRemesherError(message || `Remeshing failed with code ${code}`, code);
    }
    try {
